...
import static com.aquabasilea.migrosapi.service.config.MigrosApiConst.CENTER_ID_PLACEHOLDER;
import static com.aquabasilea.migrosapi.service.config.MigrosApiConst.COURSE_ID_TAC_PLACEHOLDER;
...
public class BookCourseHelper {
    ...
    public BookCourseHelper(UrlConfig urlConfig, String migrosBookCourseRequestBody) {
    ...
    public HttpRequest getCancelCourseRequest(MigrosApiCancelCourseRequest migrosApiCancelCourseRequest, String authorization) {
        ...
        return HttpRequest.getHttpRequest(HttpMethod.DELETE, urlConfig.getDeleteBookedCoursesUrl())
    ...
    public HttpRequest getBookedCoursesRequest(String authorization) {
        return HttpRequest.getHttpRequest(HttpMethod.GET, urlConfig.getGetBookedCoursesUrl())
                .withAuthorization(authorization);
    }
    ...
    public HttpRequest getBookCourseHttpRequest(String centerId, String courseId, String authorization) {
        return HttpRequest.getHttpRequest(HttpMethod.POST, urlConfig.getBookCourseUrl())
