...
//      migrosApi.bookCourse(new MigrosApiBookCourseRequest("CORExpress 25 Min.", "1", "139"));
   ...
   private MigrosApiBookCourseResponse handleDryRun(MigrosApiBookCourseRequest migrosApiBookCourseRequest, String courseIdTac, String bearerToken) {
      if (isValidRequestValues(migrosApiBookCourseRequest, courseIdTac, bearerToken)) {
   ...
   private static boolean isValidRequestValues(MigrosApiBookCourseRequest migrosApiBookCourseRequest, String courseIdTac, String bearerToken) {
      return nonNull(courseIdTac)
              && StringUtils.isNotEmpty(bearerToken)
              && getDuration(migrosApiBookCourseRequest) > 0;
   }
