package com.aquabasilea.ui.login.service;
...
public class LoginService extends Service<LoginResult> {
   ...
   public LoginService(Supplier<String> usernameSupplier, Supplier<char[]> userPwdSupplier, BiFunction<String, String, Boolean> loginFunction) {
