...
public class CourseComparator implements Comparator<Course> {
   ...
   public int compare(Course course1, Course course2) {
      LocalDateTime courseDate1 = LocalDateTimeBuilder.createLocalDateTime(course1.getDayOfWeek(), course1.getTimeOfTheDay());
      LocalDateTime courseDate2 = LocalDateTimeBuilder.createLocalDateTime(course2.getDayOfWeek(), course2.getTimeOfTheDay());
