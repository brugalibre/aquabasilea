...
import com.aquabasilea.app.i18n.TextResources;
...
public class AquabasileaCourseBookerSystemTray implements CourseBookingStateChangedHandler {
   ...
   private MenuItem createExitMenu() {
      MenuItem exitItem = new MenuItem(com.aquabasilea.app.i18n.TextResources.EXIT_APP);
   ...
   private void createStartBookingMenuItem() {
      refreshCoursesItem = new MenuItem(com.aquabasilea.app.i18n.TextResources.REFRESH_COURSES_LABEL);
   ...
   private void createPauseBookingMenuItem() {
      pauseOrSuspendCourseBookerItem = new MenuItem(com.aquabasilea.app.i18n.TextResources.PAUSE_APP);
   ...
   private void updateTrayIconState() {
      if (aquabasileaCourseBooker.isBookingCourse()) {
         ...
         pauseOrSuspendCourseBookerItem.setLabel(com.aquabasilea.app.i18n.TextResources.RESUME_APP);
      } else {
