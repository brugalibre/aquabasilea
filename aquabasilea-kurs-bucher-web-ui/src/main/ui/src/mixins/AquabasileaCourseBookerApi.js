...
export default {
    ...
    methods: {
        ...
        cancelBookedCourseAndRefresh: function (bookingId) {
            axios.delete(AQUABASILEA_COURSE_BOOKER_API_URL + '/cancel/' + bookingId, {headers: authHeader()})
                .then(() => this.$emit('refreshBookedCourses'))
                .catch(error => console.error("Error occurred while canceling course " + bookingId, error));
        },
